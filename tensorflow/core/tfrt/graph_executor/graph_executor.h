...
class GraphExecutor {
 public:
  ...
  // inputs/outputs. The sorted input/output names are needed to consistently
  // build the key for looking up the `LoadedClientGraph` in the cache. The
  // original indices are needed to map the results to the original
  // inputs/outputs.

...
TEST(CacheMissHandlerTest, MultipleAppendsReturnDifferentOffsets) {
  ...
  EXPECT_THAT(offset_to_addr.find(loc1.offset), Not(offset_to_addr.end()));
  EXPECT_THAT(offset_to_addr.find(loc2.offset), Not(offset_to_addr.end()));
  EXPECT_THAT(offset_to_addr.find(loc1.offset),
              Not(offset_to_addr.find(loc2.offset)));
}

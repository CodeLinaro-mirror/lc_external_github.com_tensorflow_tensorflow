...
absl::Status Mul(AbstractContext* ctx, AbstractTensorHandle* x,
                 AbstractTensorHandle* y, AbstractTensorHandle** z,
...
//   ```
absl::Status Conj(AbstractContext* ctx, AbstractTensorHandle* input,
...
//   broadcasting
//   [here](http://docs.scipy.org/doc/numpy/user/basics.broadcasting.html)
absl::Status AddV2(AbstractContext* ctx, AbstractTensorHandle* x,
                   AbstractTensorHandle* y, AbstractTensorHandle** z,
                   const char* name, const char* raw_device_name) {
  AbstractOperationPtr op_ptr(ctx->CreateOperation());
...
//   cublas.
absl::Status MatMul(AbstractContext* ctx, AbstractTensorHandle* a,
                    AbstractTensorHandle* b, AbstractTensorHandle** product,
                    bool transpose_a, bool transpose_b, bool grad_a,
                    bool grad_b, const char* name,
                    const char* raw_device_name) {
  AbstractOperationPtr op_ptr(ctx->CreateOperation());
...
// Description:
//   I.e., \\(y = -x\\).
absl::Status Neg(AbstractContext* ctx, AbstractTensorHandle* x,
...
//   length 1.
absl::Status Sum(AbstractContext* ctx, AbstractTensorHandle* input,
                 AbstractTensorHandle* reduction_indices,
...
//   [here](http://docs.scipy.org/doc/numpy/user/basics.broadcasting.html)
absl::Status Sub(AbstractContext* ctx, AbstractTensorHandle* x,
                 AbstractTensorHandle* y, AbstractTensorHandle** z,
                 const char* name, const char* raw_device_name) {
  AbstractOperationPtr op_ptr(ctx->CreateOperation());
...
//   [here](http://docs.scipy.org/doc/numpy/user/basics.broadcasting.html)
absl::Status Div(AbstractContext* ctx, AbstractTensorHandle* x,
                 AbstractTensorHandle* y, AbstractTensorHandle** z,
                 const char* name, const char* raw_device_name) {
  AbstractOperationPtr op_ptr(ctx->CreateOperation());
...
//   [here](http://docs.scipy.org/doc/numpy/user/basics.broadcasting.html)
absl::Status DivNoNan(AbstractContext* ctx, AbstractTensorHandle* x,
                      AbstractTensorHandle* y, AbstractTensorHandle** z,
                      const char* name, const char* raw_device_name) {
  AbstractOperationPtr op_ptr(ctx->CreateOperation());
...
//     ```
absl::Status Exp(AbstractContext* ctx, AbstractTensorHandle* x,
                 AbstractTensorHandle** y, const char* name,
                 const char* raw_device_name) {
  AbstractOperationPtr op_ptr(ctx->CreateOperation());
...
// Description:
//   I.e., \\(y = \sqrt{x} = x^{1/2}\\).
absl::Status Sqrt(AbstractContext* ctx, AbstractTensorHandle* x,
                  AbstractTensorHandle** y, const char* name,
                  const char* raw_device_name) {
  AbstractOperationPtr op_ptr(ctx->CreateOperation());
...
absl::Status SqrtGrad(AbstractContext* ctx, AbstractTensorHandle* y,
                      AbstractTensorHandle* dy, AbstractTensorHandle** z,
                      const char* name, const char* raw_device_name) {
  AbstractOperationPtr op_ptr(ctx->CreateOperation());
...
//   ```
absl::Status Log1p(AbstractContext* ctx, AbstractTensorHandle* x,
                   AbstractTensorHandle** y, const char* name,
                   const char* raw_device_name) {
  AbstractOperationPtr op_ptr(ctx->CreateOperation());

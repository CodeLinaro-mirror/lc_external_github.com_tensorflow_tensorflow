...
class IfrtIrLoadedExecutableTest
 ...
 protected:
  ...
  DeserializeExecutableVersion(std::string serialized_executable_version_str,
    ...
    std::unique_ptr<xla::ifrt::IfrtIrExecutableVersionDeserializeOptions>
        deserialize_options = std::make_unique<
            xla::ifrt::IfrtIrExecutableVersionDeserializeOptions>(
    ...
    ASSIGN_OR_RETURN(
        std::unique_ptr<xla::ifrt::ExecutableVersion>

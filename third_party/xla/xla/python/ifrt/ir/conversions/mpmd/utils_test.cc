...
std::vector<ShardingParamConversionTestStruct>
ShardingParamConversionTestCases() {
  return {
      ...
      {HloSharding::PartialTile(
           TileAssignment({4, 3, 2}, {2, 3, 4}, {2, 1, 0})),
       {120, 96},
       {"x", "y", "z"},
       {2, 3, 4}},
      ...
      {HloSharding::PartialTile(TileAssignment({2, 1, 12}, {24}, {0})),
       ...
       {2, 3, 4}},
      {HloSharding::PartialTile(
           TileAssignment({3, 1, 8}, {2, 3, 4}, {1, 0, 2})),
       {120, 96},
       {"x", "y", "z"},
       {2, 3, 4}},
      ...
      {HloSharding::PartialTile(TileAssignment({1, 12, 2}, {2, 12}, {1, 0})),
       ...
       {2, 3, 4}},
      {HloSharding::PartialTile(
           TileAssignment({3, 2, 1, 4}, {2, 3, 4}, {1, 0, 2})),
       {120, 96, 72},
       {"x", "y", "z"},
       {2, 3, 4}},
      {HloSharding::PartialTile(
           TileAssignment({2, 4, 1, 3}, {2, 3, 4}, {0, 2, 1})),
       {120, 96, 72},
       {"x", "y", "z"},
       {2, 3, 4}},
      {HloSharding::PartialTile(
           TileAssignment({4, 3, 1, 2}, {2, 3, 4}, {2, 1, 0})),
       {120, 96, 72},
       {"x", "y", "z"},
       {2, 3, 4}},
      {HloSharding::PartialTile(TileAssignment({12, 1, 1, 2}, {2, 12}, {1, 0})),
       {120, 96, 72},
       {"x", "y", "z"},
       {2, 3, 4}},
...
INSTANTIATE_TEST_SUITE_P(
    ...
    testing::ValuesIn(ShardingParamConversionTestCases()));

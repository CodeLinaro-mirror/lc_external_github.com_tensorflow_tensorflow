...
You can provide names both of the generated files`. They are recognized by their
suffixes: `.cc` and `.h`. The build system enforces that all output files go in the same directory.
""",
        ),
        "alwayslink": attr.bool(
            default = False,
            doc = """
See cc_library.alwayslink
""",
        ),
        "linkstatic": attr.bool(
            default = False,
            doc = """
See cc_library.linkstatic
""",
        ),
        "flatten": attr.bool(
            doc = """

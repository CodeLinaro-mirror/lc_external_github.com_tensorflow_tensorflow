...
class VectorizeXTilePass
 ...
 public:
  ...
  void runOnOperation() override {
    ...
    target.addIllegalOp<shlo::DotGeneralOp, shlo::TransposeOp,
    ...
    patterns.add<ConvertExtractTile, ConvertInsertTile, VectorizeConstantOp,
                 VectorizeDotGeneralOp, VectorizeTransposeOp>(type_converter,
                                                              context);

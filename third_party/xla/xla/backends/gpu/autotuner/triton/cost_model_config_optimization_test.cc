...
TEST(CostModelConfigOptimizationTest,
  ...
  detail::CostModelGemmTilingOptions parsed =
...
TEST_F(HloHardwareIndependentTestBase,
  ...
  std::vector<TritonGemmConfig> optimized = OptimizeConfigsWithCostModel(
      dot, all_configs, all_configs, h100_device_info, debug_options,
      &mlir_context);

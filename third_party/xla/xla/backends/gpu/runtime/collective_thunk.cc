...
absl::StatusOr<ThunkProto> CollectiveDoneThunk::ToProto() const {
  ...
  *proto.mutable_thunk_info() = thunk_info().ToProto();
  ...
  thunk_proto->set_thunk_kind(kind());
  return proto;
}
...
CollectiveDoneThunk::FromProto(
  ...
  return std::make_unique<CollectiveDoneThunk>(
      static_cast<Thunk::Kind>(thunk_proto.thunk_kind()), std::move(thunk_info),
      async_events, thunk_proto.async_stream_kind());
}

...
class TritonFusion : public FusionInterface {
 public:
  ...
  // Ideally, we should pass the values
  // extracted from the Triton module after compilation, but there are use-cases
  // where we want to call the function without compiling, e.g. during cost
  // modelling. In that case, the function calculates the values.

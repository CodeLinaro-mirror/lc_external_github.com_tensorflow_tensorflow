...
func.func @lower_dot_scaled_add_to_triton(%lhs: tensor<128x128xf8E5M2>, %lhs_scale: tensor<128x4xi8>, %rhs: tensor<128x256xf8E5M2>, %rhs_scale: tensor<256x4xi8>, %acc: tensor<128x256xf32>) -> tensor<128x256xf32> {
  ...
  %0 = xtile.dot_scaled %lhs scale %lhs_scale, %rhs scale %rhs_scale {fastMath = true} : tensor<128x128xf8E5M2>, tensor<128x4xi8> * tensor<128x256xf8E5M2>, tensor<256x4xi8> -> tensor<128x256xf32>
...
func.func @lower_dot_scaled_without_add_falls_back_to_xtile(%lhs: tensor<128x128xf8E5M2>, %lhs_scale: tensor<128x4xi8>, %rhs: tensor<128x256xf8E5M2>, %rhs_scale: tensor<256x4xi8>) -> tensor<128x256xf32> {

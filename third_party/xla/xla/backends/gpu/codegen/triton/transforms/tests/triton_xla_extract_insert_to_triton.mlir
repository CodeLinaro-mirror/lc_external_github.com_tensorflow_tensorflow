...
module {
  func.func @parameter_into_broadcast_dot_with_3_or_more_stages_does_not_use_tma(
            %arg0: !tt.ptr<f32>, %arg1: !tt.ptr<f32>, %arg2: !tt.ptr<f32>) {
    ...
    %0 = tt.expand_dims %extracted_tile {axis = 1 : i32} : tensor<64xf32> -> tensor<64x1xf32>
    %1 = tt.broadcast %0 : tensor<64x1xf32> -> tensor<64x64xf32>
    %extracted_tile_0 = triton_xla.extract from %arg1 as
        memref<64x64xf32, #triton_xla.layout<[1, 0]>> [0, 0] [64, 64] [1, 1] : tensor<64x64xf32>
...
// CHECK-TMA-LABEL: tt.func @parameter_into_broadcast_dot_with_3_or_more_stages_does_not_use_tma

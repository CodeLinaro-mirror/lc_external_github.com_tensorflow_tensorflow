...
struct SymbolicTiledHloInstructionOperandAgnosticHash {
...
struct SymbolicTiledHloInstructionOperandAgnosticEq {
...
using SymbolicTiledHloInstructionOrderedSet =
    OrderedUniquePtrValueHashSet<SymbolicTiledHloInstruction,
                                 SymbolicTiledHloInstructionOperandAgnosticHash,
                                 SymbolicTiledHloInstructionOperandAgnosticEq>;
...
ComposeIndexingResult ComposeInstructionIndexing(
    ...
    IndexingMap::SimplifyPointDimensions simplification_mode,
    SymbolicTiledHloInstructionOrderedSet& tiled_hlo_instructions_set,

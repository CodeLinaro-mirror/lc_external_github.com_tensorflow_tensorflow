...
static absl::StatusOr<HloInstruction*> RemoveDeadTupleIndices(
  ...
  auto remove_dead_original_arrays =
  ...
  remove_dead_original_arrays(while_init, new_while_init, old_to_new_tuple_idx);
  remove_dead_original_arrays(while_op, new_while_op, old_to_new_tuple_idx);

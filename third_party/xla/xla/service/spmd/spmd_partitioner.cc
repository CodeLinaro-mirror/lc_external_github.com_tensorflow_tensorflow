...
absl::StatusOr<bool> SpmdPartitioner::RunImpl(
  ...
  if (options_.allow_module_signature_change) {
    ...
    auto update_layout = [&](Shape* new_shape, const Shape& old_layout) {
      TF_RETURN_IF_ERROR(
          LayoutUtil::CopyLayoutBetweenShapes(old_layout, new_shape));
      ShapeUtil::ForEachMutableSubshape(
          new_shape, [&](Shape* subshape, const xla::ShapeIndex& index) {

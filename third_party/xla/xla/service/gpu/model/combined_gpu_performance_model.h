...
class CombinedGpuPerformanceModel : public GpuPerformanceModelBase {
 public:
  ...
  // Invalidates all cache entries related to given instruction which is, or was
  // a part of, given computation.
  absl::Status Invalidate(const HloComputation& computation,

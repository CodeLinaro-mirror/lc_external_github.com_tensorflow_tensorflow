...
class DeviceDescription {
 public:
  ...
  SemanticVersion device_driver_version() const {
    return device_driver_version_;
  }
  ...
  void set_device_driver_version(const SemanticVersion& value) {
    device_driver_version_ = value;
  }
 ...
 private:
  ...
  SemanticVersion device_driver_version_{0, 0, 0};

...
// See source:
// https://docs.nvidia.com/cuda/cuda-driver-api/group__CUDA__TENSOR__MEMORY.html
absl::Status IsTmaCompatible(absl::Span<const uint64_t> global_shape,
                             absl::Span<const uint32_t> tile_shape,
                             absl::Span<const uint64_t> tile_strides,
                             absl::Span<const uint64_t> minor_to_major_layout,

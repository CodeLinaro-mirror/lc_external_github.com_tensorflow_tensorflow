...
class PjRtClient {
 public:
  ...
  ABSL_DEPRECATED("Use GetPinnedHostAllocator instead.")
  ...
  // Returns the host memory allocator for the client if supported.
  virtual absl::StatusOr<HostMemoryAllocator*> GetHostMemoryAllocator() const {
    return absl::UnimplementedError(
        "GetHostMemoryAllocator is not implemented.");
  }

...
class CommonPjRtLoadedExecutable : public PjRtLoadedExecutable {
 public:
  ...
  CommonPjRtLoadedExecutable(DispatchInfo shape)
      : parameter_device_shapes_(std::move(shape.parameter_device_shapes)),
        parameters_that_must_be_donated_(
            std::move(shape.parameters_that_must_be_donated)),
        output_device_shape_(std::move(shape.output_device_shape)),
        output_memory_space_kind_ids_(
            std::move(shape.output_memory_space_kind_ids)),
        input_buffer_sizes_in_bytes_(
            std::move(shape.input_buffer_sizes_in_bytes)),
        addressable_devices_(std::move(shape.addressable_devices)),
        addressable_device_logical_ids_(
            std::move(shape.addressable_device_logical_ids)),
        device_assignment_(std::move(shape.device_assignment)) {}

...
using CrossHostRecvNotifierFunction =
    std::function<void(PJRT_Error*, const char**, size_t*, size_t,
                       PJRT_Transfers_CrossHostSendCancelNotifier, void*)>;
using CrossHostSendCancelNotifierFunction = std::function<void(
    const char*, size_t, PJRT_Error_Code, const char*, size_t,
    PJRT_Transfers_CrossHostOnCanceledCallback, void*)>;
using CrossHostOnCanceledCallbackFunction = std::function<void(PJRT_Error*)>;

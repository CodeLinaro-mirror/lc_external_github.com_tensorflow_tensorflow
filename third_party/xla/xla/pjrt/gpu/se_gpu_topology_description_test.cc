...
TEST(StreamExecutorGpuTopologyDescriptionTest, SymmetricTopology) {
  ...
  CheckDeviceDescription(*device_descs[2], 2, 1, {0, 1, 0});
  CheckDeviceDescription(*device_descs[3], 3, 1, {0, 1, 1});
  CheckDeviceDescription(*device_descs[4], 4, 2, {1, 0, 0});
  CheckDeviceDescription(*device_descs[5], 5, 2, {1, 0, 1});
  CheckDeviceDescription(*device_descs[6], 6, 3, {1, 1, 0});
  CheckDeviceDescription(*device_descs[7], 7, 3, {1, 1, 1});
}

...
class BufferUse {
 public:
  ...
  static constexpr ContentValidity kUndefined = ContentValidity::kUndefined;
  static constexpr ContentValidity kDefinedOnInput =
      ContentValidity::kDefinedOnInput;
  static constexpr ContentValidity kDefinedOnOutput =
      ContentValidity::kDefinedOnOutput;
  static constexpr ContentValidity kDefinedOnInputAndOutput =
  ...
  bool HasDefinedContentsOnInput() const {
    return static_cast<uint32_t>(content_validity_) &
           static_cast<uint32_t>(kDefinedOnInput);
  }
  ...
  bool HasDefinedContentsOnOutput() const {
    return static_cast<uint32_t>(content_validity_) &
           static_cast<uint32_t>(kDefinedOnOutput);
  }
  ...
  friend void AbslStringify(Sink& sink, const BufferUse& use) {
    absl::Format(&sink, "{slice: %v, access: %s, content_validity: %s%s}",
                 use.slice_, use.access() == kRead ? "R" : "W",

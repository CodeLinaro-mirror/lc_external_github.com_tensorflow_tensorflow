...
class Communicator {
 public:
  ...
  // Register `buffer` once for efficient collective operations (i.e. on NCCL
  // backend it registers the buffer for zero-copy collective operations).
  //
  virtual absl::Status RegisterBufferOnce(se::StreamExecutor* executor,

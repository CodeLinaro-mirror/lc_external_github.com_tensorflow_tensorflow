...
TEST(MeshAxesReplicaGroupListTest, MaterializedReplicaGroups) {
  ...
  MeshAxesReplicaGroupList replica_group_none(mesh_xy, /*axes=*/{});
  ...
  MeshAxesReplicaGroupList replica_group_x(mesh_xy,
                                           /*axes=*/{AxisRef(0)});
  ...
  MeshAxesReplicaGroupList replica_group_y(mesh_xy,
                                           /*axes=*/{AxisRef(1)});
  ...
  MeshAxesReplicaGroupList replica_group_xy(mesh_xy,
...
TEST(MeshAxesReplicaGroupListTest, MaterializedReplicaGroupsWithSubaxes) {
  ...
  MeshAxesReplicaGroupList replica_group_b_1_3_a_1_3(
      mesh,
      /*axes=*/{AxisRef(1, {1, 3}), AxisRef(0, {1, 3})});
...
TEST(MeshAxesReplicaGroupListTest, MaterializedReplicaGroupsMatchExpectedV2) {
  ...
  MeshAxesReplicaGroupList v3_subaxis_1_2_and_4_2(
      mesh, /*axes=*/{AxisRef(0, {1, 2}), AxisRef(0, {4, 2})});
  ...
  MeshAxesReplicaGroupList v3_subaxis_4_2_and_1_2(
      mesh, /*axes=*/{AxisRef(0, {4, 2}), AxisRef(0, {1, 2})});
...
TEST(MeshAxesReplicaGroupListTest, ValidateInputAxesForFullAxesAndSubAxes) {
  Mesh mesh(TileAssignment(IotaTileAssignment::Create(
                /*dims=*/{12, 12, 12})),
            /*axes_names=*/{"1", "2", "3"});
  testing::ScopedMockLog log(testing::kDoNotCaptureLogsYet);
  EXPECT_CALL(log, Log(base_logging::WARNING, testing::_,
                       testing::HasSubstr("Redundant axis definition")))
      .Times(1);
  log.StartCapturingLogs();
  MeshAxesReplicaGroupList replica_group_across_no_axes(
      mesh,
      /*axes=*/{AxisRef(0, {1, 2}), AxisRef(0, {2, 2}), AxisRef(0)});
}
...
TEST(MeshAxesReplicaGroupListTest, ValidateSubAxesCoexistenceCheck) {
  ...
  MeshAxesReplicaGroupList replica_group_multiple_subaxes1(
      mesh,
      /*axes=*/{AxisRef(0, {1, 2}), AxisRef(0, {4, 2})});
  ...
  EXPECT_DEATH(
      {
        MeshAxesReplicaGroupList overlapping_subaxes(
            overlap_mesh, /*axes=*/{AxisRef(0, {6, 5}), AxisRef(0, {10, 3})});
      },

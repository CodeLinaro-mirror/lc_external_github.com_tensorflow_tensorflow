...
class HloConvolutionInstruction : public HloInstruction {
 public:
  explicit HloConvolutionInstruction(
      ...
      ConvolutionKind conv_kind = CONVOLUTION_KIND_UNSET);
  ...
  ConvolutionKind conv_kind() const { return conv_kind_; }
  void set_conv_kind(ConvolutionKind conv_kind) { conv_kind_ = conv_kind; }
 ...
 private:
  ...
  ConvolutionKind conv_kind_ = CONVOLUTION_KIND_UNSET;
};
